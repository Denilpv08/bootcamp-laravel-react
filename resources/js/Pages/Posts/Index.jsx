        ...
        <AuthenticatedLayout user={auth}>
            ...
            <div className="max-w-2x1 mx-auto p-4 sm:p-6 lg:p-8">
                <form onSubmit={submit}>
                    ...
                    <InputError message={errors.title} className="mt-2" />
                    <PrimaryButton
                        className="mt-4 text-while bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-ms px-5 py-2.5 text-center mr-2 mb-21"
                        disabled={processing}
                    >
                        Create
                    </PrimaryButton>
